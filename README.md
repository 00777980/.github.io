...
- Developed multiple gas control strategies validated under rapid load changes.
...
- Integrating machine vision, sensors, and actuator
...
- Appied YOLOv11 pose estimation, trained HistGradientBoosting models for fall classification
